...
<div class="container">
<!-- 
<h1 class="text-success" style="color:#fff;"> This is Shopping Cart Site</h1>  -->
<div class="text-center" style="font-size:20px; color:#fff;">

<div class="text-success text-center" style="font-size:20px; color:#fff;">${msg} </div>
<div class="text-center" style="font-size:20px; color:#fff;">${loginMessage} </div>
${role}
<center style="font-size:20px; color:#fff;">${successR}</center>
<center style="font-size:20px; color:#fff;">${errorR}</center>
</div>
...
<div class="row">
 ...
 <span class="icon-bar"></span>
  ...
  <li> <a href="contact" >Contact</a></li>
   ...
   <jsp:include page="../ProductMenu/Menu.jsp"></jsp:include>
